...
void startRender(const PxVec3& cameraEye, const PxVec3& cameraDir, PxReal clipNear, PxReal clipFar)
{
	...
	drawText(display_text, 10, 500 - 10);
	drawText(controles_1, 10, 500 - 25);
	drawText(controles_2, 10, 500 - 40);
	drawText(controles_3, 10, 500 - 55);
	drawText(controles_4, 10, 500 - 70);
	drawText(controles_5, 10, 500 - 85);
	drawText(controles_6, 10, 500 - 25);
	...
	glLoadIdentity();
	gluLookAt(GLdouble(cameraEye.x), GLdouble(cameraEye.y), GLdouble(cameraEye.z), 
		GLdouble(cameraEye.x + cameraDir.x), GLdouble(cameraEye.y + cameraDir.y), GLdouble(cameraEye.z + cameraDir.z), 
		0.0, 1.0, 0.0);
